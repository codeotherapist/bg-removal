  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
      ...
      <div>
        ...
        <p className='my-6 text-[15px] text-gray-500'>"With every background we remove, your subject steps into the spotlight.<br className='max-sm:hidden'/>whether it’s for your online store, portfolio, or social post — background gone means impact on."</p>
        <div>
